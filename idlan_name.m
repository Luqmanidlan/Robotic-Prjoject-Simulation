...
%%
L3.qlim = [0 3]; % up/down of prismatic joint for link 3
...
P52 = transl(matrix(52,1),matrix(52,2),matrix(51,3));
P53 = transl(matrix(53,1),matrix(53,2),matrix(51,3));
P54 = transl(matrix(54,1),matrix(54,2),matrix(51,3));
P55 = transl(matrix(55,1),matrix(55,2),matrix(51,3));
P56 = transl(matrix(56,1),matrix(56,2),matrix(51,3));
P57 = transl(matrix(57,1),matrix(57,2),matrix(51,3));
P58 = transl(matrix(58,1),matrix(58,2),matrix(51,3));
...
q52_P52 = Rob.fkine(q52);
q53_P53 = Rob.fkine(q53);
q54_P54 = Rob.fkine(q54);
q55_P55 = Rob.fkine(q55);
q56_P56 = Rob.fkine(q56);
q57_P57 = Rob.fkine(q57);
q58_P58 = Rob.fkine(q58);

%% Trajectory path of the robot
trajectorypath = [20 16 0;
21	17 0;
22	18 0;
24	20 0;
25	22 0;
...
% 52
line52 = jtraj(q51,q52,t);
Rob.plot(line52, 'workspace', [-40 100 -40 100 -40 100]);

% 53
line53 = jtraj(q52,q53,t);
Rob.plot(line53, 'workspace', [-40 100 -40 100 -40 100]);

% 54
line54 = jtraj(q53,q54,t);
Rob.plot(line54, 'workspace', [-40 100 -40 100 -40 100]);

% 55
line55 = jtraj(q54,q55,t);
Rob.plot(line55, 'workspace', [-40 100 -40 100 -40 100]);

% 56
line56 = jtraj(q55,q56,t);
Rob.plot(line56, 'workspace', [-40 100 -40 100 -40 100]);

% 57
line57 = jtraj(q56,q57,t);
Rob.plot(line57, 'workspace', [-40 100 -40 100 -40 100]);

% 58
line58 = jtraj(q57,q58,t);
Rob.plot(line58, 'workspace', [-40 100 -40 100 -40 100]);
